...
// Example values:
// - "https://cdn.teleport.dev" (official Community Edition binaries)
// - "https://github.com/<owner>/<repo>/releases/download/latest" (this fork's AGPL binaries)
...
func getCDNBaseURL(buildType string, version *semver.Version) (string, error) {
	...
	// AGPL builds distribute their own binaries; default to this fork's GitHub Releases.
	if buildType == modules.BuildOSS {
		return defaults.DefaultAGPLCDNBaseURL, nil
	}
